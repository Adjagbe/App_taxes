            ...
            <div className=" mt-44 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center flex-col ">
                ...
                <div className="mt-18">
                    <form className=" sm:w-full lg:w-2xl p-7 rounded-lg bg-white flex flex-col space-y-4 ">
                        ...
                        <button className="h-14 mt-5 hover:border-[#0565AD] hover:border-2 hover:bg-transparent hover:text-[#0565AD] bg-[#0565AD] btn shadow-none border-0 text-white w-[14rem] rounded-lg px-4 text-lg font-medium flex justify-center items-center">
                            Commencer
                        </button>
                    </form>
                </div>
